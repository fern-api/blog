...
const Toc = ({
	...
	return (
		<ul className="mt-5 flex flex-col gap-5 pl-5 font-medium text-white dark:text-neutral-200">
			{children.map((item) => (
				<li key={item.id}>
					<a
	...
	return (
		<div className="w-full px-5">
			<div className="mx-auto w-full max-w-screen-md rounded-lg border border-b-4 border-r-4 p-5 text-base leading-snug dark:border-neutral-800 dark:text-neutral-50 md:p-8 md:text-lg">
				<h2 className="mb-5 text-lg text-white font-bold md:text-xl">Table of contents</h2>
