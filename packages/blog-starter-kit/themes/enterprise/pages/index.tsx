				...
				<Container className="flex flex-col items-stretch gap-10 px-5 pb-10">
					...
					{allPosts.length === 0 && (
						<div className="grid grid-cols-1 py-20 lg:grid-cols-3">
							<div className="col-span-1 flex flex-col items-center gap-5 text-center text-white dark:text-neutral-400 lg:col-start-2">
								<div className="w-20">
					...
					{allPosts.length > 0 && (
						<div className=" grid grid-cols-4 rounded-lg px-5 py-5 dark:bg-neutral-900 md:py-10">
